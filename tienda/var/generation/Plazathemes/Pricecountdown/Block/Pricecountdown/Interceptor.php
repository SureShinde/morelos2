<?php
namespace Plazathemes\Pricecountdown\Block\Pricecountdown;

/**
 * Interceptor class for @see \Plazathemes\Pricecountdown\Block\Pricecountdown
 */
class Interceptor extends \Plazathemes\Pricecountdown\Block\Pricecountdown implements \Magento\Framework\Interception\InterceptorInterface
{
    use \Magento\Framework\Interception\Interceptor;

    public function __construct(\Magento\Framework\Registry $registry, \Magento\Catalog\Block\Product\Context $context, \Magento\Catalog\Model\ResourceModel\Product\CollectionFactory $productCollectionFactory, \Magento\Catalog\Model\Product\Visibility $catalogProductVisibility, \Magento\Framework\App\Http\Context $httpContext, \Magento\Store\Model\StoreManagerInterface $storeManager, \Magento\Catalog\Model\ProductFactory $productFactory, \Magento\Framework\App\Config\ScopeConfigInterface $scopeConfig, array $data = array())
    {
        $this->___init();
        parent::__construct($registry, $context, $productCollectionFactory, $catalogProductVisibility, $httpContext, $storeManager, $productFactory, $scopeConfig, $data);
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getCurrentProduct');
        if (!$pluginInfo) {
            return parent::getCurrentProduct();
        } else {
            return $this->___callPlugins('getCurrentProduct', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductViewCountdownConfig');
        if (!$pluginInfo) {
            return parent::getProductViewCountdownConfig($attr);
        } else {
            return $this->___callPlugins('getProductViewCountdownConfig', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getProductViewCountdownOptions');
        if (!$pluginInfo) {
            return parent::getProductViewCountdownOptions();
        } else {
            return $this->___callPlugins('getProductViewCountdownOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    public function getSliderConfig($attr)
    {
        ...
        if (!$pluginInfo) {
            return parent::getSliderConfig($attr);
        } else {
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getSliderOptions');
        if (!$pluginInfo) {
            return parent::getSliderOptions();
        } else {
            return $this->___callPlugins('getSliderOptions', func_get_args(), $pluginInfo);
        }
    }
    ...
    {
        $pluginInfo = $this->pluginList->getNext($this->subjectType, 'getShortString');
        if (!$pluginInfo) {
            return parent::getShortString($string);
        } else {
            return $this->___callPlugins('getShortString', func_get_args(), $pluginInfo);
        }
    }
